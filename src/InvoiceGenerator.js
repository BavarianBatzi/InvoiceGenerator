...
import OfferGenerator from './OfferGenerator'; // Importiere das Angebot-Komponente (anpassen, falls erforderlich)
...
function InvoiceGenerator() {
  ...
  const [isInvoiceMode, setIsInvoiceMode] = useState(true); // Zustand für die Umschaltung
  ...
  useEffect(() => {
    generatePDF();
  }, [items, recipient, invoiceNumber, projectName, invoiceDate, logo]);
